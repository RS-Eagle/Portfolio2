...
const Skills = () => {
  ...
  return (
    ...
    <div className='bg-gray-900 tab-break:p-36 p-10 pt-20 ' id='skills'>
      <h3 className='text-white tab-break:text-4xl text-3xl glowtext  text-center mb-10'>Essential Tools I use </h3>
      <div className='flex flex-wrap justify-center pt-5'>
        {skills.map((e,i)=>{
          return(
            <div key={i} className='flex justify-start glowbox bg-white bg-opacity-5 items-center w-64 m-5 border rounded-md border-white p-5 py-4 hover:bg-opacity-20  text-white cursor-cell'>
