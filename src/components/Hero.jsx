...
const Hero = ({props}) => {
  ...
  return (
    <div id='home' className='h-[100vh] bg-gray-900 flex justify-between items-center tab-break:p-24 p-0 tab-break:pt-40 pt-12'>
        <div>
        ...
        <p className='text-white glowtext tab-break:text-base text-sm mt-5 tab-break:text-left text-center  paraGraph'> Hello, I'm Raman Kumar Charak 
