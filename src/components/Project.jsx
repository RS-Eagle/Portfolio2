...
const Project = () => {
  ...
  return (
    ...
    <div  className='bg-gray-900 tab-break:pt-16  pt-20      text-white' id='projects'>
        ...
        stiffness: 100, 
        damping: 10 
      } }}} animate={inView1 ? "visible":"hidden"} className='text-white tab-break:text-4xl text-3xl glowtext  text-center mb-16'>Projects</motion.h3>
      ...
      <motion.p style={{
            ...
            overflow:"hidden"
          }}  className='uppercase  md:text-8xl text-xl    text-center glowtext whitespace-nowrap overflow-hidden'>From Concept to Work </motion.p>
      </div>
      </div>
